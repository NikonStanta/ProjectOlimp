var $ua = window.navigator.userAgent; //Получили версию браузера
var $msie = $ua.indexOf("MSIE "); //проверяем на Интернет Экспор
var $special;
jQuery("html").hide(); //скрыли html?
(function($) {
    //Функициа видимо очистки имени класса
...
<div id="special-settings-body">
    ...
    <div class="avtor">
        <a href="//lidrekon.ru" target="_blank">lidrekon.ru</a></div>
    </div>
</div>`;